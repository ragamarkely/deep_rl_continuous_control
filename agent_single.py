...
LR_CRITIC = 2e-4        # learning rate of critic
WEIGHT_DECAY = 0        # L2 weight decay
UPDATE_EVERY = 1       # Time step intervals between network updates
...
class Agent:
    ...
    def step(
        ...
        # Learn every UPDATE_EVERY steps if there are enough samples in memory.
